...
---
//[link](../../index.md)/[com.tink.service.account](../index.md)/[[common]AccountService](index.md)



# AccountService  
 [common] interface [AccountService](index.md)   
...
| <a name="com.tink.service.account/AccountService/listAccounts/#/PointingToDeclaration/"></a>[listAccounts](list-accounts.md)| <a name="com.tink.service.account/AccountService/listAccounts/#/PointingToDeclaration/"></a>[common]  <br>Content  <br>abstract suspend fun [listAccounts](list-accounts.md)(): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[Account](../../com.tink.model.account/[common]-account/index.md)>  <br><br><br>
...
| <a name="com.tink.service.account/AccountService/update/#com.tink.service.account.UpdateAccountDescriptor/PointingToDeclaration/"></a>[update](update.md)| <a name="com.tink.service.account/AccountService/update/#com.tink.service.account.UpdateAccountDescriptor/PointingToDeclaration/"></a>[common]  <br>Content  <br>abstract suspend fun [update](update.md)(descriptor: [UpdateAccountDescriptor](../[common]-update-account-descriptor/index.md)): [Account](../../com.tink.model.account/[common]-account/index.md)  <br><br><br>
