//[link](../../index.md)/[com.tink.service.account](../index.md)/[[androidJvm]AccountServiceImpl](index.md)



# AccountServiceImpl  
 [androidJvm] class [AccountServiceImpl](index.md)@Inject()constructor(**api**: AccountApi) : [AccountService](../[android-jvm]-account-service/index.md)   
...
| <a name="com.tink.service.account/AccountServiceImpl/update/#com.tink.service.account.UpdateAccountDescriptor/PointingToDeclaration/"></a>[update](update.md)| <a name="com.tink.service.account/AccountServiceImpl/update/#com.tink.service.account.UpdateAccountDescriptor/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open suspend override fun [update](update.md)(descriptor: [UpdateAccountDescriptor](../[android-jvm]-update-account-descriptor/index.md)): [Account](../../com.tink.model.account/[android-jvm]-account/index.md)  <br><br><br>
