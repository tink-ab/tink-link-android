...
---
//[link](../../index.md)/[com.tink.service.account](../index.md)/[[androidJvm]AccountService](index.md)



# AccountService  
 [androidJvm] interface [AccountService](index.md)   
...
| <a name="com.tink.service.account/AccountService/listAccounts/#/PointingToDeclaration/"></a>[listAccounts](list-accounts.md)| <a name="com.tink.service.account/AccountService/listAccounts/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>abstract suspend fun [listAccounts](list-accounts.md)(): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[Account](../../com.tink.model.account/[android-jvm]-account/index.md)>  <br><br><br>
...
| <a name="com.tink.service.account/AccountService/update/#com.tink.service.account.UpdateAccountDescriptor/PointingToDeclaration/"></a>[update](update.md)| <a name="com.tink.service.account/AccountService/update/#com.tink.service.account.UpdateAccountDescriptor/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>abstract suspend fun [update](update.md)(descriptor: [UpdateAccountDescriptor](../[android-jvm]-update-account-descriptor/index.md)): [Account](../../com.tink.model.account/[android-jvm]-account/index.md)  <br><br><br>
...
|  Name| 
|---|
| <a name="com.tink.service.account/AccountServiceImpl///PointingToDeclaration/"></a>AccountServiceImpl
