---
title: INVESTMENT_TRANSACTIONS -
---
//[link](../../../index.md)/[com.tink.model.credentials](../../index.md)/[[androidJvm]RefreshableItem](../index.md)/[INVESTMENT_TRANSACTIONS](index.md)



# INVESTMENT_TRANSACTIONS  
 [androidJvm] [INVESTMENT_TRANSACTIONS](index.md)("INVESTMENT_TRANSACTIONS")  
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.credentials/RefreshableItem.INVESTMENT_TRANSACTIONS/item/#/PointingToDeclaration/"></a>[item](item.md)| <a name="com.tink.model.credentials/RefreshableItem.INVESTMENT_TRANSACTIONS/item/#/PointingToDeclaration/"></a> [androidJvm] val [item](item.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| <a name="com.tink.model.credentials/RefreshableItem.INVESTMENT_TRANSACTIONS/name/#/PointingToDeclaration/"></a>[name](name.md)| <a name="com.tink.model.credentials/RefreshableItem.INVESTMENT_TRANSACTIONS/name/#/PointingToDeclaration/"></a> [androidJvm] val [name](name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| <a name="com.tink.model.credentials/RefreshableItem.INVESTMENT_TRANSACTIONS/ordinal/#/PointingToDeclaration/"></a>[ordinal](ordinal.md)| <a name="com.tink.model.credentials/RefreshableItem.INVESTMENT_TRANSACTIONS/ordinal/#/PointingToDeclaration/"></a> [androidJvm] val [ordinal](ordinal.md): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
