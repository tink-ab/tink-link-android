...
title: UPDATING -
---
//[link](../../../../index.md)/[com.tink.model.credentials](../../../index.md)/[[common]Credentials](../../index.md)/[Status](../index.md)/[UPDATING](index.md)



# UPDATING  
 [common] [UPDATING](index.md)()  
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.credentials/Credentials.Status.UPDATING/name/#/PointingToDeclaration/"></a>[name](name.md)| <a name="com.tink.model.credentials/Credentials.Status.UPDATING/name/#/PointingToDeclaration/"></a> [common] val [name](name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
