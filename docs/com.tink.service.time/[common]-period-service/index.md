...
---
//[link](../../index.md)/[com.tink.service.time](../index.md)/[[common]PeriodService](index.md)



# PeriodService  
 [common] interface [PeriodService](index.md)   
...
| <a name="com.tink.service.time/PeriodService/getPeriod/#kotlin.String/PointingToDeclaration/"></a>[getPeriod](get-period.md)| <a name="com.tink.service.time/PeriodService/getPeriod/#kotlin.String/PointingToDeclaration/"></a>[common]  <br>Content  <br>abstract suspend fun [getPeriod](get-period.md)(name: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[Period](../../com.tink.model.time/[common]-period/index.md)>  <br><br><br>
