...
---
//[link](../../index.md)/[com.tink.service.streaming.publisher](../index.md)/[[androidJvm]StreamObserver](index.md)



# StreamObserver  
 [androidJvm] interface [StreamObserver](index.md)<[T](index.md)>   
...
| <a name="com.tink.service.streaming.publisher/StreamObserver/onCompleted/#/PointingToDeclaration/"></a>[onCompleted](on-completed.md)| <a name="com.tink.service.streaming.publisher/StreamObserver/onCompleted/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [onCompleted](on-completed.md)()  <br><br><br>
| <a name="com.tink.service.streaming.publisher/StreamObserver/onError/#kotlin.Throwable/PointingToDeclaration/"></a>[onError](on-error.md)| <a name="com.tink.service.streaming.publisher/StreamObserver/onError/#kotlin.Throwable/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [onError](on-error.md)(error: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html))  <br><br><br>
| <a name="com.tink.service.streaming.publisher/StreamObserver/onNext/#TypeParam(bounds=[kotlin.Any?])/PointingToDeclaration/"></a>[onNext](on-next.md)| <a name="com.tink.service.streaming.publisher/StreamObserver/onNext/#TypeParam(bounds=[kotlin.Any?])/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [onNext](on-next.md)(value: [T](index.md))  <br><br><br>
