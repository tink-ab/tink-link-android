//[link](../../index.md)/[com.tink.service.streaming.publisher](../index.md)/[[common]Stream](index.md)



# Stream  
 [common] interface [Stream](index.md)<[T](index.md)>   
...
| <a name="com.tink.service.streaming.publisher/Stream/subscribe/#com.tink.service.streaming.publisher.StreamObserver[TypeParam(bounds=[kotlin.Any?])]/PointingToDeclaration/"></a>[subscribe](subscribe.md)| <a name="com.tink.service.streaming.publisher/Stream/subscribe/#com.tink.service.streaming.publisher.StreamObserver[TypeParam(bounds=[kotlin.Any?])]/PointingToDeclaration/"></a>[common]  <br>Content  <br>abstract fun [subscribe](subscribe.md)(observer: [StreamObserver](../[common]-stream-observer/index.md)<[T](index.md)>): [StreamSubscription](../[common]-stream-subscription/index.md)  <br><br><br>
