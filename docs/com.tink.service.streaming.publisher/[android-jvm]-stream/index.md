---
title: [androidJvm]Stream -
---
//[link](../../index.md)/[com.tink.service.streaming.publisher](../index.md)/[[androidJvm]Stream](index.md)



# Stream  
 [androidJvm] interface [Stream](index.md)<[T](index.md)>   
...
| <a name="com.tink.service.streaming.publisher/Stream/subscribe/#com.tink.service.streaming.publisher.StreamObserver[TypeParam(bounds=[kotlin.Any?])]/PointingToDeclaration/"></a>[subscribe](subscribe.md)| <a name="com.tink.service.streaming.publisher/Stream/subscribe/#com.tink.service.streaming.publisher.StreamObserver[TypeParam(bounds=[kotlin.Any?])]/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>abstract fun [subscribe](subscribe.md)(observer: [StreamObserver](../[android-jvm]-stream-observer/index.md)<[T](index.md)>): [StreamSubscription](../[android-jvm]-stream-subscription/index.md)  <br><br><br>
...
|  Name| 
|---|
| <a name="com.tink.service.streaming/PollingHandler///PointingToDeclaration/"></a>PollingHandler
