//[link](../../../index.md)/[com.tink.link.payments](../../index.md)/[[androidJvm]TransferFailure](../index.md)/[Reason](index.md)



# Reason  
 [androidJvm] sealed class [Reason](index.md)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.payments/TransferFailure.Reason.AuthenticationError///PointingToDeclaration/"></a>[AuthenticationError](-authentication-error/index.md)| <a name="com.tink.link.payments/TransferFailure.Reason.AuthenticationError///PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>class [AuthenticationError](-authentication-error/index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?) : [TransferFailure.Reason](index.md)  <br><br><br>
| <a name="com.tink.link.payments/TransferFailure.Reason.TransferFailed///PointingToDeclaration/"></a>[TransferFailed](-transfer-failed/index.md)| <a name="com.tink.link.payments/TransferFailure.Reason.TransferFailed///PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>class [TransferFailed](-transfer-failed/index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?) : [TransferFailure.Reason](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.payments/TransferFailure.Reason/message/#/PointingToDeclaration/"></a>[message](message.md)| <a name="com.tink.link.payments/TransferFailure.Reason/message/#/PointingToDeclaration/"></a> [androidJvm] val [message](message.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
