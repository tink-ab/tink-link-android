...
---
//[link](../../../index.md)/[com.tink.link.payments](../../index.md)/[[androidJvm]TransferStatus](../index.md)/[AwaitingAuthentication](index.md)



# AwaitingAuthentication  
 [androidJvm] class [AwaitingAuthentication](index.md)(**authenticationTask**: [AuthenticationTask](../../../com.tink.link.authentication/[android-jvm]-authentication-task/index.md)) : [TransferStatus](../index.md)

There is an outstanding authentication waiting that needs to be completed by the user to proceed with the transfer.
