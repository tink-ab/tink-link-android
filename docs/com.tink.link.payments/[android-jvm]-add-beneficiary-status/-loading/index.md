//[link](../../../index.md)/[com.tink.link.payments](../../index.md)/[[androidJvm]AddBeneficiaryStatus](../index.md)/[Loading](index.md)



# Loading  
 [androidJvm] data class [Loading](index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?) : [AddBeneficiaryStatus](../index.md)

The beneficiary creation is being processed by Tink. There is currently no user action required.
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading///PointingToDeclaration/"></a>message| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading///PointingToDeclaration/"></a><br><br>a message containing details about the status.<br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading/Loading/#kotlin.String?/PointingToDeclaration/"></a>[Loading](-loading.md)| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading/Loading/#kotlin.String?/PointingToDeclaration/"></a> [androidJvm] fun [Loading](-loading.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null)a message containing details about the status.   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?  <br><br><br>
| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading/copy/#kotlin.String?/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading/copy/#kotlin.String?/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null): [AddBeneficiaryStatus.Loading](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading/message/#/PointingToDeclaration/"></a>[message](message.md)| <a name="com.tink.link.payments/AddBeneficiaryStatus.Loading/message/#/PointingToDeclaration/"></a> [androidJvm] val [message](message.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = nulla message containing details about the status.   <br>
