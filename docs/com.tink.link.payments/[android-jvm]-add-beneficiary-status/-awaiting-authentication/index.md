//[link](../../../index.md)/[com.tink.link.payments](../../index.md)/[[androidJvm]AddBeneficiaryStatus](../index.md)/[AwaitingAuthentication](index.md)



# AwaitingAuthentication  
 [androidJvm] class [AwaitingAuthentication](index.md)(**authenticationTask**: [AuthenticationTask](../../../com.tink.link.authentication/[android-jvm]-authentication-task/index.md)) : [AddBeneficiaryStatus](../index.md)

There is an outstanding [authentication](authentication-task.md) waiting that needs to be completed by the user to proceed with adding the beneficiary.
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.payments/AddBeneficiaryStatus.AwaitingAuthentication/AwaitingAuthentication/#com.tink.link.authentication.AuthenticationTask/PointingToDeclaration/"></a>[AwaitingAuthentication](-awaiting-authentication.md)| <a name="com.tink.link.payments/AddBeneficiaryStatus.AwaitingAuthentication/AwaitingAuthentication/#com.tink.link.authentication.AuthenticationTask/PointingToDeclaration/"></a> [androidJvm] fun [AwaitingAuthentication](-awaiting-authentication.md)(authenticationTask: [AuthenticationTask](../../../com.tink.link.authentication/[android-jvm]-authentication-task/index.md))   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.payments/AddBeneficiaryStatus.AwaitingAuthentication/authenticationTask/#/PointingToDeclaration/"></a>[authenticationTask](authentication-task.md)| <a name="com.tink.link.payments/AddBeneficiaryStatus.AwaitingAuthentication/authenticationTask/#/PointingToDeclaration/"></a> [androidJvm] val [authenticationTask](authentication-task.md): [AuthenticationTask](../../../com.tink.link.authentication/[android-jvm]-authentication-task/index.md)   <br>
