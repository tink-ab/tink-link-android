//[link](../../index.md)/[com.tink.service.category](../index.md)/[[common]CategoryServiceImpl](index.md)



# CategoryServiceImpl  
 [common] class [CategoryServiceImpl](index.md)constructor(**api**: <ERROR CLASS>) : [CategoryService](../[common]-category-service/index.md)   
...
| <a name="com.tink.service.category/CategoryServiceImpl/getCategoryTree/#/PointingToDeclaration/"></a>[getCategoryTree](get-category-tree.md)| <a name="com.tink.service.category/CategoryServiceImpl/getCategoryTree/#/PointingToDeclaration/"></a>[common]  <br>Content  <br>open suspend override fun [getCategoryTree](get-category-tree.md)(): [CategoryTree](../../com.tink.model.category/[common]-category-tree/index.md)  <br><br><br>
