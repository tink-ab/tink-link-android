//[link](../../../index.md)/[com.tink.link.ui](../../index.md)/[[androidJvm]TinkLinkError](../index.md)/[FailedToAddCredentials](index.md)



# FailedToAddCredentials  
 [androidJvm] data class [FailedToAddCredentials](index.md)(**errorsByCredentialsId**: [Map](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-map/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), [TinkLinkErrorInfo](../../[android-jvm]-tink-link-error-info/index.md)>) : [TinkLinkError](../index.md)
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkError.FailedToAddCredentials/FailedToAddCredentials/#kotlin.collections.Map[kotlin.String,com.tink.link.ui.TinkLinkErrorInfo]/PointingToDeclaration/"></a>[FailedToAddCredentials](-failed-to-add-credentials.md)| <a name="com.tink.link.ui/TinkLinkError.FailedToAddCredentials/FailedToAddCredentials/#kotlin.collections.Map[kotlin.String,com.tink.link.ui.TinkLinkErrorInfo]/PointingToDeclaration/"></a> [androidJvm] fun [FailedToAddCredentials](-failed-to-add-credentials.md)(errorsByCredentialsId: [Map](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-map/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), [TinkLinkErrorInfo](../../[android-jvm]-tink-link-error-info/index.md)>)   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkError.FailedToAddCredentials/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.link.ui/TinkLinkError.FailedToAddCredentials/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): [Map](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-map/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), [TinkLinkErrorInfo](../../[android-jvm]-tink-link-error-info/index.md)>  <br><br><br>
| <a name="com.tink.link.ui/TinkLinkError.FailedToAddCredentials/copy/#kotlin.collections.Map[kotlin.String,com.tink.link.ui.TinkLinkErrorInfo]/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.link.ui/TinkLinkError.FailedToAddCredentials/copy/#kotlin.collections.Map[kotlin.String,com.tink.link.ui.TinkLinkErrorInfo]/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(errorsByCredentialsId: [Map](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-map/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), [TinkLinkErrorInfo](../../[android-jvm]-tink-link-error-info/index.md)>): [TinkLinkError.FailedToAddCredentials](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkError.FailedToAddCredentials/errorsByCredentialsId/#/PointingToDeclaration/"></a>[errorsByCredentialsId](errors-by-credentials-id.md)| <a name="com.tink.link.ui/TinkLinkError.FailedToAddCredentials/errorsByCredentialsId/#/PointingToDeclaration/"></a> [androidJvm] val [errorsByCredentialsId](errors-by-credentials-id.md): [Map](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-map/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), [TinkLinkErrorInfo](../../[android-jvm]-tink-link-error-info/index.md)>A map of failed credentials ids to [errors](../../[android-jvm]-tink-link-error-info/index.md)   <br>
