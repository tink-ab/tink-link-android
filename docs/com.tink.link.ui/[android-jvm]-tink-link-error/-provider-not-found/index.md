...
---
//[link](../../../index.md)/[com.tink.link.ui](../../index.md)/[[androidJvm]TinkLinkError](../index.md)/[ProviderNotFound](index.md)



# ProviderNotFound  
 [androidJvm] data class [ProviderNotFound](index.md)(**providerName**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [TinkLinkError](../index.md)
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkError.ProviderNotFound/ProviderNotFound/#kotlin.String/PointingToDeclaration/"></a>[ProviderNotFound](-provider-not-found.md)| <a name="com.tink.link.ui/TinkLinkError.ProviderNotFound/ProviderNotFound/#kotlin.String/PointingToDeclaration/"></a> [androidJvm] fun [ProviderNotFound](-provider-not-found.md)(providerName: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkError.ProviderNotFound/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.link.ui/TinkLinkError.ProviderNotFound/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)  <br><br><br>
| <a name="com.tink.link.ui/TinkLinkError.ProviderNotFound/copy/#kotlin.String/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.link.ui/TinkLinkError.ProviderNotFound/copy/#kotlin.String/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(providerName: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [TinkLinkError.ProviderNotFound](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkError.ProviderNotFound/providerName/#/PointingToDeclaration/"></a>[providerName](provider-name.md)| <a name="com.tink.link.ui/TinkLinkError.ProviderNotFound/providerName/#/PointingToDeclaration/"></a> [androidJvm] val [providerName](provider-name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
