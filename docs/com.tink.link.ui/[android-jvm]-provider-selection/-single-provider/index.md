//[link](../../../index.md)/[com.tink.link.ui](../../index.md)/[[androidJvm]ProviderSelection](../index.md)/[SingleProvider](index.md)



# SingleProvider  
 [androidJvm] data class [SingleProvider](index.md)(**name**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [ProviderSelection](../index.md)

Adapt the UI to launch directly into a single provider with a unique [name](name.md) identifier. This will launch the create credentials view directly and skip the provider list selection.
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/ProviderSelection.SingleProvider///PointingToDeclaration/"></a>[kotlin.IllegalArgumentException](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-illegal-argument-exception/index.html)| <a name="com.tink.link.ui/ProviderSelection.SingleProvider///PointingToDeclaration/"></a><br><br>If [name](name.md) is empty.<br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/ProviderSelection.SingleProvider/SingleProvider/#kotlin.String/PointingToDeclaration/"></a>[SingleProvider](-single-provider.md)| <a name="com.tink.link.ui/ProviderSelection.SingleProvider/SingleProvider/#kotlin.String/PointingToDeclaration/"></a> [androidJvm] fun [SingleProvider](-single-provider.md)(name: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/ProviderSelection.SingleProvider/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.link.ui/ProviderSelection.SingleProvider/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)  <br><br><br>
| <a name="com.tink.link.ui/ProviderSelection.SingleProvider/copy/#kotlin.String/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.link.ui/ProviderSelection.SingleProvider/copy/#kotlin.String/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(name: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [ProviderSelection.SingleProvider](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/ProviderSelection.SingleProvider/name/#/PointingToDeclaration/"></a>[name](name.md)| <a name="com.tink.link.ui/ProviderSelection.SingleProvider/name/#/PointingToDeclaration/"></a> [androidJvm] val [name](name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
