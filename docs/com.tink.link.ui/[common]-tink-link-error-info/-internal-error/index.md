//[link](../../../index.md)/[com.tink.link.ui](../../index.md)/[[common]TinkLinkErrorInfo](../index.md)/[InternalError](index.md)



# InternalError  
 [common] data class [InternalError](index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [TinkLinkErrorInfo](../index.md)
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkErrorInfo.InternalError/InternalError/#kotlin.String/PointingToDeclaration/"></a>[InternalError](-internal-error.md)| <a name="com.tink.link.ui/TinkLinkErrorInfo.InternalError/InternalError/#kotlin.String/PointingToDeclaration/"></a> [common] fun [InternalError](-internal-error.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkErrorInfo.InternalError/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.link.ui/TinkLinkErrorInfo.InternalError/component1/#/PointingToDeclaration/"></a>[common]  <br>Content  <br>operator fun [component1](component1.md)(): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)  <br><br><br>
| <a name="com.tink.link.ui/TinkLinkErrorInfo.InternalError/copy/#kotlin.String/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.link.ui/TinkLinkErrorInfo.InternalError/copy/#kotlin.String/PointingToDeclaration/"></a>[common]  <br>Content  <br>fun [copy](copy.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [TinkLinkErrorInfo.InternalError](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.link.ui/TinkLinkErrorInfo.InternalError/message/#/PointingToDeclaration/"></a>[message](message.md)| <a name="com.tink.link.ui/TinkLinkErrorInfo.InternalError/message/#/PointingToDeclaration/"></a> [common] open override val [message](message.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)The error message   <br>
