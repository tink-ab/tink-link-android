//[link](../../../../index.md)/[com.tink.model.insights](../../../index.md)/[[androidJvm]InsightAction](../../index.md)/[Data](../index.md)/[ViewTransactions](index.md)



# ViewTransactions  
 [androidJvm] data class [ViewTransactions](index.md)(**transactionIds**: [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)>) : [InsightAction.Data](../index.md)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.insights/InsightAction.Data.ViewTransactions/ViewTransactions/#kotlin.String/PointingToDeclaration/"></a>[ViewTransactions](-view-transactions.md)| <a name="com.tink.model.insights/InsightAction.Data.ViewTransactions/ViewTransactions/#kotlin.String/PointingToDeclaration/"></a> [androidJvm] fun [ViewTransactions](-view-transactions.md)(transactionId: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.insights/InsightAction.Data.ViewTransactions/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.model.insights/InsightAction.Data.ViewTransactions/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)>  <br><br><br>
| <a name="com.tink.model.insights/InsightAction.Data.ViewTransactions/copy/#kotlin.collections.List[kotlin.String]/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.model.insights/InsightAction.Data.ViewTransactions/copy/#kotlin.collections.List[kotlin.String]/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(transactionIds: [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)>): [InsightAction.Data.ViewTransactions](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.insights/InsightAction.Data.ViewTransactions/transactionIds/#/PointingToDeclaration/"></a>[transactionIds](transaction-ids.md)| <a name="com.tink.model.insights/InsightAction.Data.ViewTransactions/transactionIds/#/PointingToDeclaration/"></a> [androidJvm] val [transactionIds](transaction-ids.md): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)>   <br>
