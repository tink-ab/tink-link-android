...
---
//[link](../../index.md)/[com.tink.model.insights](../index.md)/[[common]InsightState](index.md)



# InsightState  
 [common] sealed class [InsightState](index.md)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.insights/InsightState.Active///PointingToDeclaration/"></a>[Active](-active/index.md)| <a name="com.tink.model.insights/InsightState.Active///PointingToDeclaration/"></a>[common]  <br>Content  <br>object [Active](-active/index.md) : [InsightState](index.md)  <br><br><br>
| <a name="com.tink.model.insights/InsightState.Archived///PointingToDeclaration/"></a>[Archived](-archived/index.md)| <a name="com.tink.model.insights/InsightState.Archived///PointingToDeclaration/"></a>[common]  <br>Content  <br>data class [Archived](-archived/index.md)(**archivedDate**: <ERROR CLASS>) : [InsightState](index.md)  <br><br><br>
