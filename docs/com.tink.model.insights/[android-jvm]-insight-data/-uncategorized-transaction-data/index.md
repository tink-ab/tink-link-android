//[link](../../../index.md)/[com.tink.model.insights](../../index.md)/[[androidJvm]InsightData](../index.md)/[UncategorizedTransactionData](index.md)



# UncategorizedTransactionData  
 [androidJvm] data class [UncategorizedTransactionData](index.md)(**transactionId**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [InsightData](../index.md)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.insights/InsightData.UncategorizedTransactionData/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.model.insights/InsightData.UncategorizedTransactionData/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)  <br><br><br>
| <a name="com.tink.model.insights/InsightData.UncategorizedTransactionData/copy/#kotlin.String/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.model.insights/InsightData.UncategorizedTransactionData/copy/#kotlin.String/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(transactionId: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [InsightData.UncategorizedTransactionData](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.insights/InsightData.UncategorizedTransactionData/transactionId/#/PointingToDeclaration/"></a>[transactionId](transaction-id.md)| <a name="com.tink.model.insights/InsightData.UncategorizedTransactionData/transactionId/#/PointingToDeclaration/"></a> [androidJvm] val [transactionId](transaction-id.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
