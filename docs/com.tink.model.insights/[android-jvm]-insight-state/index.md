---
title: [androidJvm]InsightState -
---
//[link](../../index.md)/[com.tink.model.insights](../index.md)/[[androidJvm]InsightState](index.md)



# InsightState  
 [androidJvm] sealed class [InsightState](index.md) : [Parcelable](https://developer.android.com/reference/kotlin/android/os/Parcelable.html)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.insights/InsightState.Active///PointingToDeclaration/"></a>[Active](-active/index.md)| <a name="com.tink.model.insights/InsightState.Active///PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>object [Active](-active/index.md) : [InsightState](index.md)  <br><br><br>
| <a name="com.tink.model.insights/InsightState.Archived///PointingToDeclaration/"></a>[Archived](-archived/index.md)| <a name="com.tink.model.insights/InsightState.Archived///PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>data class [Archived](-archived/index.md)(**archivedDate**: Instant) : [InsightState](index.md)  <br><br><br>
...
|  Name| 
|---|
| <a name="com.tink.model.insights/InsightState.Archived///PointingToDeclaration/"></a>InsightState
| <a name="com.tink.model.insights/InsightState.Active///PointingToDeclaration/"></a>InsightState
