...
title: PFM_DATA -
---
//[link](../../../../index.md)/[com.tink.model.account](../../../index.md)/[[androidJvm]Account](../../index.md)/[AccountExclusion](../index.md)/[PFM_DATA](index.md)



# PFM_DATA  
 [androidJvm] [PFM_DATA](index.md)()  
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.account/Account.AccountExclusion.PFM_DATA/name/#/PointingToDeclaration/"></a>[name](name.md)| <a name="com.tink.model.account/Account.AccountExclusion.PFM_DATA/name/#/PointingToDeclaration/"></a> [androidJvm] val [name](name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
