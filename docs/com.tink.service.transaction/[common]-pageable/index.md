//[link](../../index.md)/[com.tink.service.transaction](../index.md)/[[common]Pageable](index.md)



# Pageable  
 [common] interface [Pageable](index.md)   
...
| <a name="com.tink.service.transaction/Pageable/hasMore/#/PointingToDeclaration/"></a>[hasMore](has-more.md)| <a name="com.tink.service.transaction/Pageable/hasMore/#/PointingToDeclaration/"></a>[common]  <br>Content  <br>abstract fun [hasMore](has-more.md)(): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)  <br><br><br>
| <a name="com.tink.service.transaction/Pageable/next/#com.tink.service.handler.ResultHandler[kotlin.Unit]/PointingToDeclaration/"></a>[next](next.md)| <a name="com.tink.service.transaction/Pageable/next/#com.tink.service.handler.ResultHandler[kotlin.Unit]/PointingToDeclaration/"></a>[common]  <br>Content  <br>abstract fun [next](next.md)(resultHandler: [ResultHandler](../../com.tink.service.handler/[common]-result-handler/index.md)<[Unit](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)>)  <br><br><br>
