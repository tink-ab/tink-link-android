...
---
//[link](../../index.md)/[com.tink.model.relations](../index.md)/[[androidJvm]ExpensesByDay](index.md)



# ExpensesByDay  
 [androidJvm] data class [ExpensesByDay](index.md)(**date**: LocalDate, **totalAmount**: [Amount](../../com.tink.model.misc/[android-jvm]-amount/index.md), **averageAmount**: [Amount](../../com.tink.model.misc/[android-jvm]-amount/index.md)) : [Parcelable](https://developer.android.com/reference/kotlin/android/os/Parcelable.html)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.relations/ExpensesByDay/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.model.relations/ExpensesByDay/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): LocalDate  <br><br><br>
...
| <a name="com.tink.model.relations/ExpensesByDay/component3/#/PointingToDeclaration/"></a>[component3](component3.md)| <a name="com.tink.model.relations/ExpensesByDay/component3/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component3](component3.md)(): [Amount](../../com.tink.model.misc/[android-jvm]-amount/index.md)  <br><br><br>
| <a name="com.tink.model.relations/ExpensesByDay/copy/#org.threeten.bp.LocalDate#com.tink.model.misc.Amount#com.tink.model.misc.Amount/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.model.relations/ExpensesByDay/copy/#org.threeten.bp.LocalDate#com.tink.model.misc.Amount#com.tink.model.misc.Amount/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(date: LocalDate, totalAmount: [Amount](../../com.tink.model.misc/[android-jvm]-amount/index.md), averageAmount: [Amount](../../com.tink.model.misc/[android-jvm]-amount/index.md)): [ExpensesByDay](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.relations/ExpensesByDay/averageAmount/#/PointingToDeclaration/"></a>[averageAmount](average-amount.md)| <a name="com.tink.model.relations/ExpensesByDay/averageAmount/#/PointingToDeclaration/"></a> [androidJvm] val [averageAmount](average-amount.md): [Amount](../../com.tink.model.misc/[android-jvm]-amount/index.md)   <br>
| <a name="com.tink.model.relations/ExpensesByDay/date/#/PointingToDeclaration/"></a>[date](date.md)| <a name="com.tink.model.relations/ExpensesByDay/date/#/PointingToDeclaration/"></a> [androidJvm] val [date](date.md): LocalDate   <br>
| <a name="com.tink.model.relations/ExpensesByDay/totalAmount/#/PointingToDeclaration/"></a>[totalAmount](total-amount.md)| <a name="com.tink.model.relations/ExpensesByDay/totalAmount/#/PointingToDeclaration/"></a> [androidJvm] val [totalAmount](total-amount.md): [Amount](../../com.tink.model.misc/[android-jvm]-amount/index.md)   <br>
