---
title: [androidJvm]YearPeriod -
---
//[link](../../index.md)/[com.tink.model.time](../index.md)/[[androidJvm]YearPeriod](index.md)



# YearPeriod  
 [androidJvm] data class [YearPeriod](index.md)(**year**: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), **identifier**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), **start**: Instant, **end**: Instant) : [Period](../[android-jvm]-period/index.md)   
...
| <a name="com.tink.model.time/YearPeriod/component3/#/PointingToDeclaration/"></a>[component3](component3.md)| <a name="com.tink.model.time/YearPeriod/component3/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component3](component3.md)(): Instant  <br><br><br>
| <a name="com.tink.model.time/YearPeriod/component4/#/PointingToDeclaration/"></a>[component4](component4.md)| <a name="com.tink.model.time/YearPeriod/component4/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component4](component4.md)(): Instant  <br><br><br>
| <a name="com.tink.model.time/YearPeriod/copy/#kotlin.Int#kotlin.String#org.threeten.bp.Instant#org.threeten.bp.Instant/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.model.time/YearPeriod/copy/#kotlin.Int#kotlin.String#org.threeten.bp.Instant#org.threeten.bp.Instant/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(year: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), identifier: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), start: Instant, end: Instant): [YearPeriod](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.time/YearPeriod/end/#/PointingToDeclaration/"></a>[end](end.md)| <a name="com.tink.model.time/YearPeriod/end/#/PointingToDeclaration/"></a> [androidJvm] open override val [end](end.md): Instant   <br>
| <a name="com.tink.model.time/YearPeriod/identifier/#/PointingToDeclaration/"></a>[identifier](identifier.md)| <a name="com.tink.model.time/YearPeriod/identifier/#/PointingToDeclaration/"></a> [androidJvm] open override val [identifier](identifier.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| <a name="com.tink.model.time/YearPeriod/start/#/PointingToDeclaration/"></a>[start](start.md)| <a name="com.tink.model.time/YearPeriod/start/#/PointingToDeclaration/"></a> [androidJvm] open override val [start](start.md): Instant   <br>
| <a name="com.tink.model.time/YearPeriod/year/#/PointingToDeclaration/"></a>[year](year.md)| <a name="com.tink.model.time/YearPeriod/year/#/PointingToDeclaration/"></a> [androidJvm] val [year](year.md): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
