//[link](../../index.md)/[com.tink.model.user](../index.md)/[[common]Authorization](index.md)



# Authorization  
 [common] sealed class [Authorization](index.md)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.user/Authorization.AccessToken///PointingToDeclaration/"></a>[AccessToken](-access-token/index.md)| <a name="com.tink.model.user/Authorization.AccessToken///PointingToDeclaration/"></a>[common]  <br>Content  <br>data class [AccessToken](-access-token/index.md)(**accessToken**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Authorization](index.md)  <br><br><br>
| <a name="com.tink.model.user/Authorization.SessionId///PointingToDeclaration/"></a>[SessionId](-session-id/index.md)| <a name="com.tink.model.user/Authorization.SessionId///PointingToDeclaration/"></a>[common]  <br>Content  <br>data class [SessionId](-session-id/index.md)(**sessionId**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Authorization](index.md)  <br><br><br>
