...
---
//[link](../../index.md)/[com.tink.model.user](../index.md)/[[androidJvm]Authorization](index.md)



# Authorization  
 [androidJvm] sealed class [Authorization](index.md) : [Parcelable](https://developer.android.com/reference/kotlin/android/os/Parcelable.html)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.user/Authorization.AccessToken///PointingToDeclaration/"></a>[AccessToken](-access-token/index.md)| <a name="com.tink.model.user/Authorization.AccessToken///PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>data class [AccessToken](-access-token/index.md)(**accessToken**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Authorization](index.md)  <br><br><br>
| <a name="com.tink.model.user/Authorization.SessionId///PointingToDeclaration/"></a>[SessionId](-session-id/index.md)| <a name="com.tink.model.user/Authorization.SessionId///PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>data class [SessionId](-session-id/index.md)(**sessionId**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Authorization](index.md)  <br><br><br>
...
|  Name| 
|---|
| <a name="com.tink.model.user/Authorization.AccessToken///PointingToDeclaration/"></a>Authorization
| <a name="com.tink.model.user/Authorization.SessionId///PointingToDeclaration/"></a>Authorization
