---
title: [androidJvm]User -
---
//[link](../../index.md)/[com.tink.model.user](../index.md)/[[androidJvm]User](index.md)



# User  
 [androidJvm] data class [User](index.md)(**authorization**: [Authorization](../[android-jvm]-authorization/index.md)) : [Parcelable](https://developer.android.com/reference/kotlin/android/os/Parcelable.html)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.user/User.Companion///PointingToDeclaration/"></a>[Companion](-companion/index.md)| <a name="com.tink.model.user/User.Companion///PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>object [Companion](-companion/index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.user/User/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.model.user/User/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): [Authorization](../[android-jvm]-authorization/index.md)  <br><br><br>
| <a name="com.tink.model.user/User/copy/#com.tink.model.user.Authorization/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.model.user/User/copy/#com.tink.model.user.Authorization/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(authorization: [Authorization](../[android-jvm]-authorization/index.md)): [User](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.user/User/authorization/#/PointingToDeclaration/"></a>[authorization](authorization.md)| <a name="com.tink.model.user/User/authorization/#/PointingToDeclaration/"></a> [androidJvm] val [authorization](authorization.md): [Authorization](../[android-jvm]-authorization/index.md)   <br>
