//[link](../../../../index.md)/[com.tink.model.budget](../../../index.md)/[[androidJvm]Budget](../../index.md)/[Periodicity](../index.md)/[OneOff](index.md)



# OneOff  
 [androidJvm] data class [OneOff](index.md)(**start**: Instant, **end**: Instant) : [Budget.Periodicity](../index.md)   
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): Instant  <br><br><br>
| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/component2/#/PointingToDeclaration/"></a>[component2](component2.md)| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/component2/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component2](component2.md)(): Instant  <br><br><br>
| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/copy/#org.threeten.bp.Instant#org.threeten.bp.Instant/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/copy/#org.threeten.bp.Instant#org.threeten.bp.Instant/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(start: Instant, end: Instant): [Budget.Periodicity.OneOff](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/end/#/PointingToDeclaration/"></a>[end](end.md)| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/end/#/PointingToDeclaration/"></a> [androidJvm] val [end](end.md): Instant   <br>
| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/start/#/PointingToDeclaration/"></a>[start](start.md)| <a name="com.tink.model.budget/Budget.Periodicity.OneOff/start/#/PointingToDeclaration/"></a> [androidJvm] val [start](start.md): Instant   <br>
