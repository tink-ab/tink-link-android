...
---
//[link](../../index.md)/[com.tink.service.authentication](../index.md)/[[androidJvm]UserEventBus](index.md)



# UserEventBus  
 [androidJvm] class [UserEventBus](index.md)@Inject()constructor   
...
| <a name="com.tink.service.authentication/UserEventBus/postUser/#com.tink.model.user.User/PointingToDeclaration/"></a>[postUser](post-user.md)| <a name="com.tink.service.authentication/UserEventBus/postUser/#com.tink.model.user.User/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [postUser](post-user.md)(user: [User](../../com.tink.model.user/[android-jvm]-user/index.md))  <br><br><br>
| <a name="com.tink.service.authentication/UserEventBus/subscribe/#kotlin.Function1[com.tink.model.user.User,kotlin.Unit]/PointingToDeclaration/"></a>[subscribe](subscribe.md)| <a name="com.tink.service.authentication/UserEventBus/subscribe/#kotlin.Function1[com.tink.model.user.User,kotlin.Unit]/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [subscribe](subscribe.md)(onUserReceived: ([User](../../com.tink.model.user/[android-jvm]-user/index.md)) -> [Unit](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)): Disposable  <br><br><br>
