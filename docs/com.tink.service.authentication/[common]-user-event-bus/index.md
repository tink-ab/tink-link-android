//[link](../../index.md)/[com.tink.service.authentication](../index.md)/[[common]UserEventBus](index.md)



# UserEventBus  
 [common] class [UserEventBus](index.md)constructor   
...
| <a name="com.tink.service.authentication/UserEventBus/postUser/#com.tink.model.user.User/PointingToDeclaration/"></a>[postUser](post-user.md)| <a name="com.tink.service.authentication/UserEventBus/postUser/#com.tink.model.user.User/PointingToDeclaration/"></a>[common]  <br>Content  <br>fun [postUser](post-user.md)(user: [User](../../com.tink.model.user/[common]-user/index.md)): <ERROR CLASS>  <br><br><br>
| <a name="com.tink.service.authentication/UserEventBus/subscribe/#kotlin.Function1[com.tink.model.user.User,kotlin.Unit]/PointingToDeclaration/"></a>[subscribe](subscribe.md)| <a name="com.tink.service.authentication/UserEventBus/subscribe/#kotlin.Function1[com.tink.model.user.User,kotlin.Unit]/PointingToDeclaration/"></a>[common]  <br>Content  <br>fun [subscribe](subscribe.md)(onUserReceived: ([User](../../com.tink.model.user/[common]-user/index.md)) -> [Unit](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)): <ERROR CLASS>  <br><br><br>
