...
---
//[link](../../index.md)/[com.tink.model.consent](../index.md)/[[androidJvm]ScopeDescription](index.md)



# ScopeDescription  
 [androidJvm] data class [ScopeDescription](index.md)(**title**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), **description**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Parcelable](https://developer.android.com/reference/kotlin/android/os/Parcelable.html)

A title and description explaining a specific [Scope](../../com.tink.model.user/[android-jvm]-scope/index.md).
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.consent/ScopeDescription/ScopeDescription/#kotlin.String#kotlin.String/PointingToDeclaration/"></a>[ScopeDescription](-scope-description.md)| <a name="com.tink.model.consent/ScopeDescription/ScopeDescription/#kotlin.String#kotlin.String/PointingToDeclaration/"></a> [androidJvm] fun [ScopeDescription](-scope-description.md)(title: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), description: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.consent/ScopeDescription/component1/#/PointingToDeclaration/"></a>[component1](component1.md)| <a name="com.tink.model.consent/ScopeDescription/component1/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component1](component1.md)(): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)  <br><br><br>
| <a name="com.tink.model.consent/ScopeDescription/component2/#/PointingToDeclaration/"></a>[component2](component2.md)| <a name="com.tink.model.consent/ScopeDescription/component2/#/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>operator fun [component2](component2.md)(): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)  <br><br><br>
| <a name="com.tink.model.consent/ScopeDescription/copy/#kotlin.String#kotlin.String/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.tink.model.consent/ScopeDescription/copy/#kotlin.String#kotlin.String/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [copy](copy.md)(title: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), description: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [ScopeDescription](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.tink.model.consent/ScopeDescription/description/#/PointingToDeclaration/"></a>[description](description.md)| <a name="com.tink.model.consent/ScopeDescription/description/#/PointingToDeclaration/"></a> [androidJvm] val [description](description.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)A string describing what user data the scope provides access to.   <br>
| <a name="com.tink.model.consent/ScopeDescription/title/#/PointingToDeclaration/"></a>[title](title.md)| <a name="com.tink.model.consent/ScopeDescription/title/#/PointingToDeclaration/"></a> [androidJvm] val [title](title.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)The short string of what access the scope is for.   <br>
