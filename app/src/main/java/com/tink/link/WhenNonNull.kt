...
inline fun <P1 : Any, P2 : Any, P3 : Any, P4 : Any, P5 : Any, P6 : Any, R>
        whenNonNull(p1: P1?, p2: P2?, p3: P3?, p4: P4?, p5: P5?, p6: P6?,
                    function: (p1: P1, p2: P2, p3: P3, p4: P4, p5: P5, p6: P6) -> R): R? {
...
inline fun <P1 : Any, P2 : Any, P3 : Any, P4 : Any, P5 : Any, P6 : Any, P7 : Any, R>
        whenNonNull(p1: P1?, p2: P2?, p3: P3?, p4: P4?, p5: P5?, p6: P6?, p7: P7?,
                    function: (p1: P1, p2: P2, p3: P3, p4: P4, p5: P5, p6: P6, p7: P7) -> R): R? {
